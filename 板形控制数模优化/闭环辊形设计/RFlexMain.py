...
for I in range(1, 1 + 1):
    ...
    for N in range(1, 6 + 1):
        ...
        if N == 7: DATA_FORC.BW = 800.0
        if N == 8: DATA_FORC.BW = 1250.0
        if N == 9: DATA_FORC.BW = 1450.0
        if N == 10: DATA_FORC.BW = 1600.0
        if N == 11: DATA_FORC.BW = 1870.0
        for V in range(1, 5 + 1):
            ...
            if V == 6: DATA_FORC.QS = 0.6
            if V == 7: DATA_FORC.QS = 1.2
            if V == 8: DATA_FORC.QS = 1.8
