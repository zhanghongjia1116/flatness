...
class Ui_ClassForm(object):
    def setupUi(self, ClassForm):
        ...
        ClassForm.resize(804, 690)
        self.gridLayout = QtWidgets.QGridLayout(ClassForm)
        self.gridLayout.setObjectName("gridLayout")
        self.CardWidget_2 = CardWidget(ClassForm)
        ...
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap(":/icons/icons/成功.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap(":/icons/icons/图像.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        self.CardWidget = CardWidget(ClassForm)
        ...
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap(":/icons/icons/数据集合并.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.IconWidget_4.setIcon(icon3)
        self.IconWidget_4.setObjectName("IconWidget_4")
        self.gridLayout_2.addWidget(self.IconWidget_4, 8, 1, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.PrimaryPushButton_2, 4, 3, 1, 1)
        ...
        icon4 = QtGui.QIcon()
        icon4.addPixmap(QtGui.QPixmap(":/icons/icons/导出.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.IconWidget_2.setIcon(icon4)
        self.IconWidget_2.setObjectName("IconWidget_2")
        self.gridLayout_2.addWidget(self.IconWidget_2, 4, 1, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.PrimaryPushButton_3, 6, 3, 1, 1)
        ...
        icon5 = QtGui.QIcon()
        icon5.addPixmap(QtGui.QPixmap(":/icons/icons/打开.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.IconWidget_3.setIcon(icon5)
        ...
        self.gridLayout_2.addItem(spacerItem18, 6, 2, 1, 1)
        ...
        icon6 = QtGui.QIcon()
        icon6.addPixmap(QtGui.QPixmap(":/icons/icons/format.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.IconWidget_5.setIcon(icon6)
        ...
        self.gridLayout_2.addWidget(self.PrimaryPushButton_4, 8, 3, 1, 1)
        ...
        self.gridLayout_2.addItem(spacerItem21, 8, 2, 1, 1)
    ...
    def retranslateUi(self, ClassForm):
        ...
        self.TitleLabel_2.setText(_translate("ClassForm", "数据分析"))
        self.PrimaryPushButton_6.setToolTip(_translate("ClassForm", "导入单个酸轧在线判定表"))
        self.PrimaryPushButton_6.setText(_translate("ClassForm", "查询"))
        self.PrimaryPushButton_7.setToolTip(_translate("ClassForm", "导入单个酸轧在线判定表"))
        self.PrimaryPushButton_7.setText(_translate("ClassForm", "匹配"))
        self.PrimaryPushButton_8.setToolTip(_translate("ClassForm", "导入单个酸轧在线判定表"))
        self.PrimaryPushButton_8.setText(_translate("ClassForm", "图像分析"))
        self.TitleLabel.setText(_translate("ClassForm", "数据服务"))
        self.PrimaryPushButton_2.setToolTip(_translate("ClassForm", "导出经过处理的酸轧在线判定表"))
        self.PrimaryPushButton_2.setText(_translate("ClassForm", "导出"))
        self.PrimaryPushButton_5.setToolTip(_translate("ClassForm", "格式化酸轧在线判定的板坯牌号"))
        self.PrimaryPushButton_5.setText(_translate("ClassForm", "格式化"))
        self.PrimaryPushButton_3.setToolTip(_translate("ClassForm", "打开酸轧在线判定表的目录"))
        self.PrimaryPushButton_3.setText(_translate("ClassForm", "打开文件夹"))
        self.PrimaryPushButton.setToolTip(_translate("ClassForm", "导入单个酸轧在线判定表"))
        self.PrimaryPushButton.setText(_translate("ClassForm", "导入"))
        self.PrimaryPushButton_4.setToolTip(_translate("ClassForm", "合并酸轧在线判定表"))
        self.PrimaryPushButton_4.setText(_translate("ClassForm", "合并"))
